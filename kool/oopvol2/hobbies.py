...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    Highest amount of hobbies first. The - before len(person.hobbies) ensures the descending order.
    The second parameter full_name is used in case of a tiebreak.
